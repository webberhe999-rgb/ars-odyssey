package com.swvague.ars_odyssey.datagen;
...
import static com.swvague.ars_odyssey.datagen.Setup.provider;
import static com.hollingsworth.arsnouveau.setup.registry.RegistryHelper.getRegistryName;

public class ArsProviders {

    static String root = ArsOdyssey.MODID;
    ...
    public static class GlyphProvider extends GlyphRecipeProvider {
        ...
        public @NotNull String getName() {
            return "Ars Odyssey Glyph Recipes";
        }
    }
    ...
    public static class EnchantingAppProvider extends ApparatusRecipeProvider {
        ...
        @Override
        public @NotNull String getName() {
            return "Ars Odyssey Apparatus Recipes";
        }
    }
    ...
    public static class ImbuementProvider extends ImbuementRecipeProvider {
        ...
        @Override
        public @NotNull String getName() {
            return "Ars Odyssey Imbuement Recipes";
        }
    ...
    public static class PatchouliProvider extends com.hollingsworth.arsnouveau.common.datagen.PatchouliProvider {
        ...
        public void collectJsons(CachedOutput cache) {
            ...
            // Ars Odyssey currently reuses Ars Nouveau glyphs and does not datagen custom glyph pages.
        ...
        @Override
        public @NotNull String getName() {
            return "Ars Odyssey Patchouli Datagen";
        }
